...
async function getMoviePaymentStatus() {
    ...
    await axios
        ...
        .catch((err) => {
            errorMessage.value = "Something Went Wrong, Please try again.";
            showLoader('', true); // Hide loader
            swalNotification("error", "An error occurred while generating ticket, contact support", 5000);
            return null;
        });
}
...
<template>
    <section>
        ...
        <Head title="Verify Payment - Ticket Purchase" />
        <b-container class="mt-5">
            <HomeHeader />

            <div style="margin-top: 22vh; margin-bottom: 10vh">
                <div class="col-12">
                    <div v-if="isLoading" class="mt-5 d-flex align-items-center justify-content-center"
                        style="height: 50vh">
                                ...
                                <div class="card-body">
                                    <div v-if="isPaymentSuccessfull">
                                        <div class="mb-4 d-flex align-items-center justify-content-center">
                                            <div>
                                                <svg width="30px" height="30px" viewBox="-2.4 -2.4 28.80 28.80"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#1ae031"
                                            ...
                                            <span class="ms-2 fw-bold" style="font-size: medium; color: #1ae031">Payment
                                                Successful</span>
                                        </div>

                                        <div class="flex mb-3 text-center d-flex-column">
                                            <div class="mt-4 mb-4">
                                                <label>{{ paymentStatusdetails.message ? paymentStatusdetails.message :
                                                    "Payment successfull" }}</label>
                                            </div>
                                    ...
                                    <div v-else>
                                        <div class="mb-4 d-flex align-items-center justify-content-center">
                                            ...
                                            <span class="ms-2 fw-bold" style="font-size: medium; color: #d50000">Payment
                                                Failed</span>
                                        </div>
                                        ...
                                        <div class="flex mb-3 text-center d-flex-column">
                                            <div class="mt-4 mb-4">
                                                <label>
                                                    {{
                                                        paymentStatusdetails.message ? paymentStatusdetails.message :
                                                            `Something
                                                    wrong happened`
                                                    }}</label>
                                            </div>
