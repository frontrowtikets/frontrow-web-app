        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                        ...
                        <b-tab title="Ticket Sales - Grid" active>
                            <div v-if="eventpaginatedItems.length > 0">
                                <div class="flex-wrap gap-5 mt-5 d-flex justify-content-center">
                                    <EventTicketCard v-for="(ticket, index) in eventpaginatedItems"
                        ...
                        <b-tab title="Ticket Sales - List">
                            <div v-if="eventpaginatedItems.length > 0" class="table-responsive">
                                <table class="table table-striped mt-4">
                                    ...
                                    <tbody>
                                        <EventTicketList v-for="(ticket, index) in eventpaginatedItems"
                                            :key="`${index}_${ticket.id}`" :ticketId="ticket.ticket_id"
                                            :status="ticket.ticket_status" :event="ticket?.event"
                                            :userDetails="ticket?.user_payment_detail"
                                            :transactionDetails="ticket?.payment_transaction"
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    <div class="gap-1 mb-0 list-unstyled hstack">
                                                        <div data-bs-toggle="tooltip" data-bs-placement="top"
                                                            aria-label="View" @click="declineRequest(user.id)">
                                                            <div class="btn btn-sm btn-soft-danger"><i
                                                                    class="dripicons-cross"></i></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                        ...
                        <b-tab title="Attendance Requests" v-if="props.event_type != 'paid'">
                            <div class="mt-5 table-responsive" v-if="requestspaginatedItems.length > 0">
                                <table
                                    ...
                                    <tbody>
                                        <tr v-for="(user, index) in requestspaginatedItems"
                                            ...
                                            <td :style="{ backgroundColor: '#fff' }" class="text-end">
                                                <div class="d-flex justify-content-end">
                                                    <div class="gap-1 mb-0 list-unstyled hstack">
                                                        <div data-bs-toggle="tooltip" data-bs-placement="top"
                                                            aria-label="View" @click="acceptRequest(user.id)">
                                                            <div class="btn btn-sm btn-soft-success"><i
                        ...
                        <b-tab title="Declined" v-if="props.event_type != 'paid'">
                            <div class="mt-5 table-responsive" v-if="declinedpaginatedItems.length > 0">
                                <table
                                    ...
                                    <tbody>
                                        <tr v-for="(user, index) in declinedpaginatedItems"
                                            :key="`${index}_${user.email}`">
                                            <th scope="row" :style="{ backgroundColor: '#fff' }">
                                                <div v-if="user.user != null">
                                                    <img :src="user.user.profile_photo_url" :alt="''"
                    ...
                    <b-modal v-model="registerForEventModal" id="EventRegister" centered title="Register For Event"
                        ...
                        <div>
                            <form>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input style="font-size: 13px" type="text" class="form-control" id="name"
                                        placeholder="Name" required v-model="eventRegisterForm.name" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input style="font-size: 13px" type="email" class="form-control" id="email" required
                                ...
                                <div class="">
                                    <div class="mb-3 form-check form-check-left">
                                        ...
                                        <label class="form-check-label" for="formCheckRight1"> Allow Terms & Conditions
                                        </label>
                                        <InputError class="mt-2 mb-4 text-danger"
