...
const {paginatedItems:inactivepaginatedItems,nextPageExists:inactivenextPageExists} = useInfiniteScroll('inactiveDeneficiaries',beneficiaryRequestsTableBottom);
const {paginatedItems:deactivepaginatedItems,nextPageExists:deactivenextPageExists} = useInfiniteScroll('deactiveDeneficiaries',deactivatedTableBottom);
...
<template>
    ...
    <Layout>
        <div>
                                            ...
                                            <tr v-for="(user, index) in paginatedItems" :key="`${index}_${user.email}`">
                                                ...
                                                <td :style="{ backgroundColor: '#fff' }" class="text-center">
                                                    ...
                                                    <div v-if="user.user_type == 'beneficiary'">
                                                        ...
                                                        <div v-if="user.beneficiary_status === 'inactive'"><span class="badge badge-soft-danger">Inactive</span></div>
                                                        <div v-if="user.beneficiary_status === 'deactivated'"><span class="badge badge-soft-secondary">Deactivated</span></div>
                                                    </div>
                                                ...
                                                <td :style="{ backgroundColor: '#fff' }" class="text-end">
                                                    <div class="d-flex justify-content-end">
                                                        <div class="gap-1 mb-0 list-unstyled hstack">
                                                            ...
                                                            <div data-bs-toggle="tooltip" data-bs-placement="top" aria-label="View" @click="makeUserBeneficiary(user.name, user.id)">
                                                                <div class="btn btn-sm btn-soft-success"><i class="bx bx-check-square"></i></div>
                                                            </div>
                                                            <div data-bs-toggle="tooltip" data-bs-placement="top" aria-label="View" @click="deactivateBeneficiary(user.name, user.id)">
            ...
            <b-modal v-model="state.assignPermissionModal" id="assignRolePermission" title="Assign Permissions" title-class="font-18" centered hide-footer>
                <div class="mt-3 mb-4">
