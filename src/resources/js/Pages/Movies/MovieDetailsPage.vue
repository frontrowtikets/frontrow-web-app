                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td scope="col">{{ moment(props.movieDetails.release_date).format("MMM Do YY")
                                            }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-soft-secondary"
                                                v-if="props.movieDetails.status == 'coming_soon'">Coming Soon</span>
                                            <span class="badge badge-soft-secondary"
                                                v-if="props.movieDetails.status == 'now_showing'">Now Showing</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Language</th>
                                        <td>
                                            <span class="badge badge-soft-success">{{ props.movieDetails.languange
                                                }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-soft-info">{{ props.movieDetails.maturity_rating
                                                }}</span>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="gap-2 hstack">
                            ...
                            <button class="btn btn-soft-danger w-100" @click="editMovie"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center">
                            <img :src="props.movieDetails.beneficiary.profile_photo_url" :alt="'p'"
                            ...
                            <li>
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <p class="mb-0 text-muted fs-14">{{ props.movieDetails.beneficiary.phone_number
                                            }}</p>
                                    </div>
                                </div>
                            </li>
                        ...
                        <div class="mt-4" v-if="props.movieDetails.beneficiary_id == currentUser.id"
                            @click="goToMovieManager">
                            <a class="rounded btn btn-soft-primary btn-hover w-100"><i class="mdi mdi-eye"></i> Ticket
                                Sales</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-9">
                <div class="card">
                    <div class="card-body border-bottom background-container"
                        :style="{ backgroundImage: `url(${props.movieDetails.poster_url})` }"></div>
                    <div class="card-body">
                        <div class="flex-row d-flex col-12 justify-content-between">
                            <div class="col-5">
                                <span class="badge badge-soft-primary me-3"
                                    v-for="(genre, index) in props.movieDetails.genres" :key="index">{{
                                        genre.name
                                    }}</span>
                            </div>
                            ...
                            <div class="flex-wrap gap-5 w-100 d-flex">
                                <div class="text-center" v-for="(moviecasts, index) in movieCasts" :key="index">
                                    <div v-if="moviecasts.profile_image_url" class="mb-4">
                                        <img :src="`${moviecasts.profile_image_url}`" :alt="'img'"
                        ...
                        <div v-else>
                            <div class="mb-5" v-if="props.movieDetails.trailer_url">
                                <h5 class="mb-3 fw-semibold">Trailer:</h5>
                                <YouTube :width="300" :height="180" :src="`${props.movieDetails.trailer_url}`"
                        ...
                        <div v-if="width > 1023">
                            ...
                            <div class="col-12">
                                <div v-for="(field, index) in props.movieDetails.show_times" :key="field.id"
                                    ...
                                    <div class="mb-3 col-lg-2">{{ field.currency }}: {{
                                        useCurrencyFormat(field.ticket_price) }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="mt-3 d-flex border-bottom" v-for="(review, index) in props.movieDetails.reviews"
