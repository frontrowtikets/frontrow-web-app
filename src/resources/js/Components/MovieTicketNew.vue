...
const startTime = computed(() => {
    const starts = moment(props.theatre.start_time, "HH:mm:ss").format(
        "h:mm A"
    );
    return starts;
});
...
<template>
    <div class="p-5 d-flex align-items-center justify-content-center" id="movieticket">
        <div
            class="p-4"
        ...
        >
            <div class="mb-5 d-flex justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h5 style="color: #70aad1">MOVIE TICKET</h5>
                    </div>
                </div>
                <div
                    class=""
                ...
                <div class="flex-grow-1">
                    <div class="" style="font-size: medium">
                        ...
                        <p class="d-flex justify-content-between">
                            ...
                            }}({{ props.seatDetails?.seatmap?.room_name }})</span>
                        </p>
                        <p class="d-flex justify-content-between">
                            <strong>Seat:</strong>
                            <span style="color: black">{{ props.seatDetails.seat_number }}</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-5">
                <p class="fw-bold" style="font-size: medium; color: #47a2de">
                    Terms & Conditions:
                </p>
