    ...
    <div class="col-xl-4 col-sm-6">
        <div class="border shadow-none card">
            <div class="p-3 card-body" role="button">
                <div class="mb-3">
                    <img :src="props.eventDetails?.thumbnail_url" :alt="props.eventDetails?.title"
                ...
                <div class="">
                    <div class="float-end ms-2">
                        <b-dropdown toggle-class="p-0 font-size-16 text-muted" class="mb-2" variant="white"
                            ...
                            <b-dropdown-item @click="viewEventsDetails">View Details</b-dropdown-item>
                            <b-dropdown-item v-if="props.eventDetails?.is_active == false && isAdmin"
                                @click="activateEvent">Activate</b-dropdown-item>
                            <b-dropdown-item v-if="props.eventDetails?.is_active == true && isAdmin"
                                @click="deactivateEvent">Deactivate</b-dropdown-item>
                            <b-dropdown-item @click="editEvent">Update</b-dropdown-item>
                            <b-dropdown-item @click="viewEventsManager">Ticket Sales</b-dropdown-item>
                            <b-dropdown-item @click="viewEventsManager">Manage Event</b-dropdown-item>
                            <b-dropdown-divider></b-dropdown-divider>
                            <b-dropdown-item @click="deleteEvent"><span
                    ...
                    <div class="mb-3 avatar-xs me-3" @click="viewEventsDetails">
                        <div class="bg-transparent rounded avatar-title">
                            <i class="mdi mdi-movie-roll font-size-24 text-secondary"></i>
                        </div>
                    </div>
                    <div class="d-flex" @click="viewEventsDetails">
                        <div class="overflow-hidden me-auto">
                            <h5 class="mb-1 font-size-14 text-truncate">
                                <a href="javascript: void(0);" class="text-body">{{ props.eventDetails?.title }}
                                </a>
                            </h5>
