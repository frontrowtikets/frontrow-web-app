...
function downloadInvoice() {
    ...
    const filename = `Invoice_${props.ticketId}.pdf`;
    var options = {
        margin: 0.5,
        filename: filename,
        pagebreak: {
...
onMounted(() => {
    // console.log("MovieTicketList mounted");
    ...
    <tr class="ticket-row">
        ...
        <td class="movie-cell">
            <div class="movie-info">
                <img :src="props.movie.thumbnail_url" :alt="props.movie.title" class="movie-poster" />
                <div class="movie-details">
                    <h6 class="movie-title">{{ props.movie.title }}</h6>
                    <small class="text-muted">{{ props.theatre.theatre }}</small>
                </div>
            </div>
        </td>
        ...
        <td class="datetime-cell">
            <div class="datetime-info">
                <div class="screening-date">
                    {{ moment(props.theatre.screening_date).format("DD MMM YYYY") }}
                </div>
                <div class="screening-time">
                    {{ moment(props.theatre.start_time, "HH:mm:ss").format("h:mm A") }} -
                    {{ moment(props.theatre.end_time, "HH:mm:ss").format("h:mm A") }}
                </div>
            </div>
        </td>
        ...
        <td class="actions-cell">
            <div class="action-buttons">
                <!-- <button class="btn btn-sm btn-primary" @click="downloadTicket" title="Download Ticket">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- Uncomment if you want invoice download -->
                        <li>
        ...
        <td class="d-none">
            <MovieInvoice :movie="props.movie" :theatre="props.theatre" :userDetails="props.userDetails"
                :transactionDetails="props.transactionDetails" />
        </td>
        <td class="d-none">
            <MovieTicketNew :ticketId="props.ticketId" :movie="props.movie" :theatre="props.theatre"
                :userDetails="props.userDetails" :transactionDetails="props.transactionDetails"
