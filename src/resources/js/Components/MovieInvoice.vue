...
//  import logo from "../../images/cinemaug_logo.svg";
...
const numberOfTickets = computed(() => {
    const ticketPrice = Number(props.theatre.ticket_price);
    const totalAmountPaid = Number(props.transactionDetails.amount);
    const tickets = totalAmountPaid / ticketPrice;
