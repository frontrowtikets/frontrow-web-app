    ...
    <Layout>
        ...
        <div class="row">
            <div class="col-xl-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="mt-4 text-sm-end mt-sm-0">
                                        ...
                                        <h5>+ $ 215.53 <span class="align-bottom badge bg-success ms-1">+ 1.3 %</span></h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-4 card-title">How it work</h4>
            ...
            <div class="col-xl-8">
                            ...
                            <div class="col-lg-4">
                                <div class="p-3 mt-4 border rounded">
                                    <div class="mb-3 d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 font-size-14">Bitcoin</h5>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="p-3 mt-4 border rounded">
                                    <div class="mb-3 d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 font-size-14">Ethereum</h5>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="p-3 mt-4 border rounded">
                                    <div class="mb-3 d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 font-size-14">Litecoin</h5>
                                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-4 card-title">My Assets</h4>
                            ...
                            <table class="table mb-0 align-middle table-nowrap table-centered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="mb-1 font-size-14">1.2601</h5>
                                            <div class="text-muted">$6225.74</div>
                                        </td>
                                        <td>
                                            <h5 class="mb-1 font-size-14">0.1512</h5>
                                            <div class="text-muted">$742.32</div>
                                        </td>
                                        <td>
                                            <h5 class="mb-1 font-size-14">4.2562</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="mb-1 font-size-14">0.0814</h5>
                                            <div class="text-muted">$3256.29</div>
                                        </td>
                                        <td>
                                            <h5 class="mb-1 font-size-14">0.0253</h5>
                                            <div class="text-muted">$675.04</div>
                                        </td>
                                        <td>
                                            <h5 class="mb-1 font-size-14">0.0921</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="mb-1 font-size-14">0.0682</h5>
                                            <div class="text-muted">$2936.14</div>
                                        </td>
                                        <td>
                                            <h5 class="mb-1 font-size-14">0.0234</h5>
                                            <div class="text-muted">$523.17</div>
                                        </td>
                                        <td>
                                            <h5 class="mb-1 font-size-14">0.0823</h5>
