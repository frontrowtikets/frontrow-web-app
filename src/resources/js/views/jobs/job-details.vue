                            ...
                            <li>
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <p class="mb-0 text-muted fs-14">+589 560 56555</p>
                                    </div>
                                </div>
                            </li>
                            <li class="mt-3">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <p class="mb-0 text-muted fs-14">themesbrand@gmail.com</p>
                                    </div>
                                </div>
                            </li>
                            <li class="mt-3">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <p class="mb-0 text-muted fs-14 text-break">www.themesbrand.com</p>
                                    </div>
                                </div>
                            </li>
                            <li class="mt-3">
                                <div class="d-flex">
                                    ...
                                    <div class="ms-3">
                                        <h6 class="mb-2 fs-14">Location</h6>
                                        <p class="mb-0 text-muted fs-14">Oakridge Lane Richardson.</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        <div class="mt-4">
                            <a href="#!" class="rounded btn btn-soft-primary btn-hover w-100"><i class="mdi mdi-eye"></i> View Profile</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-9">
                <div class="card">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <ul class="gap-2 mb-0 list-unstyled hstack">
                                    <li><i class="bx bx-building-house"></i> <span class="text-muted">Themesbrand</span></li>
                                    <li><i class="bx bx-map"></i> <span class="text-muted">California</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <p class="text-muted">
                            We are looking to hire a skilled Magento developer to build and maintain eCommerce websites for our clients. As a Magento
                            developer, you will be responsible for liaising with the design team, setting up Magento 1x and 2x sites, building modules
                            and customizing extensions, testing the performance of each site, and maintaining security and feature updates after the
                        ...
                        <div class="mt-4">
                            <ul class="mb-0 list-inline">
                                <li class="mt-1 list-inline-item">Share this job:</li>
                                <li class="mt-1 list-inline-item">
                                    <a href="javascript:void(0)" class="btn btn-outline-primary btn-hover"
                                ...
                                <li class="mt-1 list-inline-item">
                                    <a href="javascript:void(0)" class="btn btn-outline-success btn-hover"
