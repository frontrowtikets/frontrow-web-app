            ...
            <b-tabs pills vertical nav-wrapper-class="col-xl-2 col-sm-3" content-class="w-100">
                <b-tab active>
                    <template v-slot:title>
                        <i class="mt-4 mb-2 bx bxs-truck d-block check-nav-icon"></i>
                        <p class="mb-4 fw-bold">Shipping Info</p>
                    </template>
                    <b-card-text>
                        <div class="card">
                            <div class="card-body">
                ...
                <b-tab>
                    <template v-slot:title>
                        <i class="mt-4 mb-2 bx bx-money d-block check-nav-icon"></i>
                        <p class="mb-4 fw-bold">Payment Info</p>
                    </template>
                    <b-card-text>
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div>
                                        <div class="custom-control custom-radio custom-control-inline me-4">
                                            ...
                                            <label class="custom-control-label" for="customRadioInline1">
                                                <i class="align-top fab fa-cc-mastercard me-1 font-size-20"></i> Credit /
                                                Debit Card
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline me-4">
                                            ...
                                            <label class="custom-control-label" for="customRadioInline2">
                                                <i class="align-top fab fa-cc-paypal me-1 font-size-20"></i> Paypal
                                            </label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline me-4">
                                            ...
                                            <label class="custom-control-label" for="customRadioInline3">
                                                <i class="align-top far fa-money-bill-alt me-1 font-size-20"></i> Cash on
                                                Delivery
                                            </label>
                                        </div>
                                    </div>
                ...
                <b-tab>
                    <template v-slot:title>
                        <i class="mt-4 mb-2 bx bx-badge-check d-block check-nav-icon"></i>
                        <p class="mb-4 fw-bold">Confirmation</p>
                    </template>
                    <b-card-text>
                        <div class="mb-0 border shadow-none card">
                            <div class="card-body">
                                <h4 class="mb-4 card-title">Order Summary</h4>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p class="mb-0 text-muted">$ 450 x 1</p>
                                                </td>
                                                <td>$ 450</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p class="mb-0 text-muted">$ 225 x 1</p>
                                                </td>
                                                <td>$ 225</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <div class="p-3 rounded bg-soft bg-primary">
                                                        <h5 class="mb-0 font-size-14 text-primary">
