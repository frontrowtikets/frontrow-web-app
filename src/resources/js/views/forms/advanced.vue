          ...
          <div class="card-body">
            ...
            <div class="col-lg-6">
              <div class="mt-4 mt-lg-0">
                <h5 class="mb-3 font-size-14">Square switch</h5>
                <div class="d-flex">
          ...
          <div class="card-body">
            ...
            <div>
              <div class="mb-3">
                ...
                <br />
                <date-picker class="form-control" v-model="defaultdate" :first-day-of-week="1" lang="en"
                  confirm></date-picker>
              </div>
              ...
              <div class="mb-3">
                ...
                <br />
                <date-picker class="form-control" v-model="daterange" range append-to-body lang="en"
                  confirm></date-picker>
              </div>
              ...
              <div class="mb-3">
                ...
                <br />
                <date-picker class="form-control" v-model="demoMonth" type="month" lang="en" confirm
                  placeholder="Select Month"></date-picker>
              </div>

              <div class="mb-3">
                <label>Year View</label>
                <br />
                <date-picker class="form-control" v-model="demoYear" type="year" lang="en" confirm
              ...
              <div class="mb-3">
                ...
                <br />
                <date-picker class="form-control" v-model="time" format="hh:mm:ss a" value-type="format" type="time"
                  placeholder="hh:mm:ss a"></date-picker>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <div>
              <label class="mt-3 mb-1 fw-medium">Threshold value</label>
            ...
            <div>
              <label class="mt-3 mb-1 fw-medium">All the options</label>
              <p class="text-muted font-13">
                Please note: if the
            ...
            <div>
              <label class="mt-3 mb-1 fw-medium">Textareas</label>
