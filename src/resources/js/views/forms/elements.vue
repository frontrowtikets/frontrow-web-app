  ...
  <Layout>
            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-sm-6">
                <div class="mt-4">
                  ...
                  <div>
                    <div class="mb-3 form-check form-check-right">
                      <input
              ...
              <div class="col-xl-3 col-sm-6">
                <div class="mt-4">
                  ...
                  <p class="mb-4 sub-header">
                    Add class
                    <code>.form-check-*</code> for a color Checkboxes
                  </p>

                  <div>
                    <div class="mb-3 form-check form-check-primary">
                      <input
                        class="form-check-input"
                        type="checkbox"
                        id="formCheckcolor1"
                    ...
                    <div class="mb-3 form-check form-check-warning">
                      <input
                        class="form-check-input"
                        type="checkbox"
                        id="formCheckcolor1"
                    ...
                    <div class="mb-3 form-check form-check-danger">
                      <input
                        class="form-check-input"
                        type="checkbox"
                        id="formCheckcolor1"
              ...
              <div class="col-xl-3 col-sm-6">
                <div class="mt-4">
                  ...
                  <div>
                    <div>
                      <div
                        class="mb-3 form-check form-checkbox-outline form-check-primary"
                      >
                        <input
                          class="form-check-input"
                          type="checkbox"
                      ...
                      <div
                        class="mb-3 form-check form-checkbox-outline form-check-success"
                      >
                        <input
                          class="form-check-input"
                          type="checkbox"
                      ...
                      <div
                        class="mb-3 form-check form-checkbox-outline form-check-info"
                      >
                        <input
                          class="form-check-input"
                          type="checkbox"
                      ...
                      <div
                        class="mb-3 form-check form-checkbox-outline form-check-warning"
                      >
                        <input
                          class="form-check-input"
                          type="checkbox"
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-xl-3 col-sm-6">
                <div class="mt-4">
                  <h5 class="mb-4 font-size-14">Default Radios</h5>
              ...
              <div class="col-xl-3 col-sm-6">
                <div class="mt-4">
                  <h5 class="mb-4 font-size-14">Form Radios Right</h5>
                  <div>
                    <div class="mb-3 form-check form-check-right">
                      <input
                        class="form-check-input"
              ...
              <div class="col-xl-3 col-sm-6">
                <div class="mt-4">
                  <h5 class="font-size-14">
                    <i class="mr-1 mdi mdi-arrow-right text-primary"></i> Form
                    Radio colors
                  </h5>
                  <p class="mb-4 sub-header">
                  ...
                  <div>
                    <div class="mb-3 form-check form-radio-primary">
                      <input
                        class="form-check-input"
                        type="radio"
                    ...
                    <div class="mb-3 form-check form-radio-success">
                      <input
                        class="form-check-input"
                        type="radio"
                    ...
                    <div class="mb-3 form-check form-radio-info">
                      <input
                        class="form-check-input"
                        type="radio"
                    ...
                    <div class="mb-3 form-check form-radio-warning">
                      <input
                        class="form-check-input"
                        type="radio"
                    ...
                    <div class="mb-3 form-check form-radio-danger">
                      <input
                        class="form-check-input"
                        type="radio"
                ...
                <div class="mt-4">
                  ...
                  <p class="mb-4 sub-header">
                    ...
                    <code>.form-radio-* </code> for a color Checkboxes
                       ...
                       <div>
                    <div
                      class="mb-3 form-check form-radio-outline form-radio-primary"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
                    ...
                    <div
                      class="mb-3 form-check form-radio-outline form-radio-success"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
                    ...
                    <div
                      class="mb-3 form-check form-radio-outline form-radio-info"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
                    ...
                    <div
                      class="mb-3 form-check form-radio-outline form-radio-warning"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
                    ...
                    <div
                      class="mb-3 form-check form-radio-outline form-radio-danger"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div>
                  <h5 class="mb-3 font-size-14">Switch examples</h5>
              ...
              <div class="col-sm-6">
                <div class="mt-4 mt-sm-0">
                  <h5 class="mb-3 font-size-14">Switch sizes</h5>

                  <div class="mb-3 form-check form-switch" dir="ltr">
                    <input
                      class="form-check-input"
                      type="checkbox"
                  ...
                  <div
                    class="mb-3 form-check form-switch form-switch-md"
                    dir="ltr"
                  >
                    <input
                      class="form-check-input"
                  ...
                  <div
                    class="mb-3 form-check form-switch form-switch-lg"
                    dir="ltr"
                  >
                    <input
                      class="form-check-input"
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h4 class="mb-4 card-title">File browser</h4>
