@php
    ...
    $screeningDate = Carbon::parse($theatre->screening_date)->format('D, d M Y');
    $startTime = Carbon::createFromFormat('H:i:s', $theatre->start_time)->format('g:i A');
    $endTime = Carbon::createFromFormat('H:i:s', $theatre->end_time)->format('g:i A');
            ...
            <div class="ticket-body">
                ...
                <table>
                    ...
                    <td style="vertical-align: middle;">
                        <div class="details">
                            <h3>{{ $movie->title }}</h3>
                            <div><strong>Date:</strong> {{ $screeningDate }}</div>
                            <div><strong>Time:</strong> {{ $startTime }} to {{ $endTime }}</div>
                            <div><strong>Theatre:</strong> {{ $theatre->theatre }}</div>
                            <div><strong>Seat:</strong> {{ $seatDetails->seat_number }}</div>
                        </div>
                    </td>
                </table>
